...
class block(ft.GestureDetector):
    def __init__(self, iscontainer=False, have_parameter=False,
        ...
        #code parser
        self.name = str("haha") #string data
    ...
    def load_template(self):
        ...
        if not self.IsHeader:
            ...
            self.block_name = "haha"#"#self.template["block name"]
            ...
            print(f"Block Setting: {self.block_setting}")
    ...
    def on_change(self,e):
        ...
        data_len = len(data)*10-(len(data)*0.553333)
    ...
    def reset_para_size(self):
        ...
        self.args_manage()
        self.posion_manage(self.data, self.para_data)
        self.width = max(150*self.scale,self.get_max_width())
