...
class vertical_tab(ft.Container):
    ...
    def container_select(self,index):
        print(index,self.select_index-1)
...
def main(page:ft.Page):
    ...
    veti = vertical_tab(tab_color="#AA00AA",render_color=white_3,select_color=white,wid=300,select_index=2,hei=1000,tabs=[tab(tab=ft.Container(content=ft.Icon(name=ft.icons.DATASET)),content=ft.Text("homo")),
